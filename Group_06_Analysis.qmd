...
#| fig-height: 6
#| message: false
ggpairs(imdb_data[, c("rating","year", "budget",  "length", "votes")], aes(color=imdb_data$rate), title="Scatterplot matrix")+
  theme_bw()
...
The @fig-scatterplots-relationship suggests that there seems to be no linear relationship between the response variable and the explanatory variables which justifies the weak correlation observed earlier.\clearpage
